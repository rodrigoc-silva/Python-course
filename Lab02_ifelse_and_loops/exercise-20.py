...
#Stock transaction program. It shows profit / loss amount (using for loop).

#input
countStks = int(input('How many stocks do you want to enter?')) 

for stocks in range(countStks):
